% Angenommen wir wollen ein Experiment bauen wo Boxen entweder grün oder blau sind und entweder links oder rechts erscheinen 
...
trilList= horzcat(trials', trialList)